    ...
    public void removeAtIndex(int position) {
        ...
        public void onBindViewHolder (@NonNull RecyclerView.ViewHolder holder,int position){
            if (getItemViewType(position) == 0) {
                ...
                buttonViewHolder.mLineView.setOnClickListener(v -> {
                    // 双击的情况---
                ...
                dataViewHolder.updateTimeView.setText("更新时间：" + mList.get(position).getUpdateTime());
        ...
        public static class ButtonViewHolder extends RecyclerView.ViewHolder {
            private final RelativeLayout mLineView;

            public ButtonViewHolder(@NonNull View itemView) {
                super(itemView);
                mLineView = itemView.findViewById(R.id.rl_create_line);
            }
        }
